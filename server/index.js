...
app.use(
  cors({
    origin: "https://video-streams-api-frontend.vercel.app", // Allow only your frontend
    methods: ["GET", "POST", "PUT", "DELETE"], // Fix syntax
...
app.use((req, res, next) => {
  res.header("Access-Control-Allow-Origin", "https://video-streams-api-frontend.vercel.app");
